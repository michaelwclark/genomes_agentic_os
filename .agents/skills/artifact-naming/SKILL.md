...
description: Inspect, migrate, or restore configurable date-prefixed durable Agentic OS entity names. Use when the user asks for Agentic OS `artifact-naming` work or when the routed Agentic OS skill registry selects `artifact-naming`.
---
...
Harness-visible adapter for the Agentic OS `artifact-naming` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/artifact-naming/SKILL.md` after routing.
