...
description: Operate runtime registries, heartbeats, schedules, run queues, and tracking. Use when the user asks for Agentic OS `runtime-operator` work or when the routed Agentic OS skill registry selects `runtime-operator`.
---
...
Harness-visible adapter for the Agentic OS `runtime-operator` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/runtime-operator/SKILL.md` after routing.
