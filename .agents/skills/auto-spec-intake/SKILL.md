...
description: Create or update local spec packets for long OS-shaping requests. Use when the user asks for Agentic OS `auto-spec-intake` work or when the routed Agentic OS skill registry selects `auto-spec-intake`.
---
...
Harness-visible adapter for the Agentic OS `auto-spec-intake` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/auto-spec-intake/SKILL.md` after routing.
