---
name: os-health
description: Inspect Mac host speed risks and Agentic OS generated-artifact hygiene with observe-only reports and approval-gated cleanup classes. Use when the user asks for Agentic OS `os-health` work or when the routed Agentic OS skill registry selects `os-health`.
---
...
Harness-visible adapter for the Agentic OS `os-health` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/os-health/SKILL.md` after routing.
