...
description: Route document captures to the configured Agentic OS filesystem and Notion destinations. Use when the user asks for Agentic OS `doc-config-router` work or when the routed Agentic OS skill registry selects `doc-config-router`.
---
...
Harness-visible adapter for the Agentic OS `doc-config-router` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/doc-config-router/SKILL.md` after routing.
