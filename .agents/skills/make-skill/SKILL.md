---
name: make-skill
description: Codex-visible adapter for Agentic OS /make-skill; create or update reusable skills, commands, workflows, or invocation surfaces. Use when the user asks for Agentic OS `make-skill` work or when the routed Agentic OS skill registry selects `make-skill`.
---
...
Harness-visible adapter for the Agentic OS `make-skill` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `.agents/skills/make-skill/SKILL.md` after routing.
