---
name: work-handoff-report
description: Generate or refine a multi-topic Agentic OS work handoff prompt pack with continuation prompts, source links, and a guarded Notion projection. Use when the user asks for Agentic OS `work-handoff-report` work or when the routed Agentic OS skill registry selects `work-handoff-report`.
---
...
Harness-visible adapter for the Agentic OS `work-handoff-report` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/work-handoff-report/SKILL.md` after routing.
