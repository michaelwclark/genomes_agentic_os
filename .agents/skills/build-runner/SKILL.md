---
name: build-runner
description: Drive a Kanban-backed implementation queue through orchestrated build phases. Use when the user asks for Agentic OS `build-runner` work or when the routed Agentic OS skill registry selects `build-runner`.
---
...
Harness-visible adapter for the Agentic OS `build-runner` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/build-runner/SKILL.md` after routing.
