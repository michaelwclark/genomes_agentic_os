...
description: Use when working or resuming LOS Jira implementation in a fast worktree with minimal chat output. Use when the user asks for Agentic OS `los-quiet-workon` work or when the routed Agentic OS skill registry selects `los-quiet-workon`.
---
...
Harness-visible adapter for the Agentic OS `los-quiet-workon` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/los-quiet-workon/SKILL.md` after routing.
