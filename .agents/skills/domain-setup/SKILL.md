---
name: domain-setup
description: Create or improve a domain room inside the OS. Use when the user asks for Agentic OS `domain-setup` work or when the routed Agentic OS skill registry selects `domain-setup`.
---
...
Harness-visible adapter for the Agentic OS `domain-setup` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/domain-setup/SKILL.md` after routing.
