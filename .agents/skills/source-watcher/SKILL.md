---
name: source-watcher
description: Configure or audit provider-agnostic connected source watchers. Use when the user asks for Agentic OS `source-watcher` work or when the routed Agentic OS skill registry selects `source-watcher`.
---
...
Harness-visible adapter for the Agentic OS `source-watcher` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/source-watcher/SKILL.md` after routing.
