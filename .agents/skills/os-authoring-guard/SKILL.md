...
description: Apply compact Agentic OS authoring rules to commands, skills, workflows, automations, tools, registries, and worktrees. Use when the user asks for Agentic OS `os-authoring-guard` work or when the routed Agentic OS skill registry selects `os-authoring-guard`.
---
...
Harness-visible adapter for the Agentic OS `os-authoring-guard` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/os-authoring-guard/SKILL.md` after routing.
