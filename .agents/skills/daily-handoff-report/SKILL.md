---
name: daily-handoff-report
description: Generate or refine the rolling daily Agentic OS handoff report with prompt-file sections, source focus areas, local receipts, and guarded Notion projection. Use when the user asks for Agentic OS `daily-handoff-report` work or when the routed Agentic OS skill registry selects `daily-handoff-report`.
---
...
Harness-visible adapter for the Agentic OS `daily-handoff-report` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/daily-handoff-report/SKILL.md` after routing.
