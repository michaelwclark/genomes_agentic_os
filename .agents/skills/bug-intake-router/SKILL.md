...
description: Capture bug reports and missed enforcement through doc-config and project work-items. Use when the user asks for Agentic OS `bug-intake-router` work or when the routed Agentic OS skill registry selects `bug-intake-router`.
---
...
Harness-visible adapter for the Agentic OS `bug-intake-router` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/bug-intake-router/SKILL.md` after routing.
