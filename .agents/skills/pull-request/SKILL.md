---
name: pull-request
description: Orchestrated GitHub PR review skill. Use when the user asks for Agentic OS `pull-request` work or when the routed Agentic OS skill registry selects `pull-request`.
---
...
Harness-visible adapter for the Agentic OS `pull-request` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/pull-request/SKILL.md` after routing.
