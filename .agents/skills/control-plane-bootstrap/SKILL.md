...
description: Plan a Notion-backed or file-backed operating control plane. Use when the user asks for Agentic OS `control-plane-bootstrap` work or when the routed Agentic OS skill registry selects `control-plane-bootstrap`.
---
...
Harness-visible adapter for the Agentic OS `control-plane-bootstrap` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/control-plane-bootstrap/SKILL.md` after routing.
