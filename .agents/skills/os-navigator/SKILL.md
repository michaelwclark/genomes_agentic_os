---
name: os-navigator
description: Route work through installed Agentic OS rooms. Use when the user asks for Agentic OS `os-navigator` work or when the routed Agentic OS skill registry selects `os-navigator`.
---
...
Harness-visible adapter for the Agentic OS `os-navigator` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/os-navigator/SKILL.md` after routing.
