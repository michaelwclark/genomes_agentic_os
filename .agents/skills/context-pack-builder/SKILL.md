...
description: Assemble focused context packs for repeatable OS workflows. Use when the user asks for Agentic OS `context-pack-builder` work or when the routed Agentic OS skill registry selects `context-pack-builder`.
---
...
Harness-visible adapter for the Agentic OS `context-pack-builder` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/context-pack-builder/SKILL.md` after routing.
