...
description: Create or update local feature packets for long OS-shaping requests. Use when the user asks for Agentic OS `auto-feature-intake` work or when the routed Agentic OS skill registry selects `auto-feature-intake`.
---
...
Harness-visible adapter for the Agentic OS `auto-feature-intake` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/auto-feature-intake/SKILL.md` after routing.
