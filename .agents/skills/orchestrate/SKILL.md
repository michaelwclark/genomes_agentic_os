---
name: orchestrate
description: Coordinate subagents, verification, and integration. Use when the user asks for Agentic OS `orchestrate` work or when the routed Agentic OS skill registry selects `orchestrate`.
---
...
Harness-visible adapter for the Agentic OS `orchestrate` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/orchestrate/SKILL.md` after routing.
