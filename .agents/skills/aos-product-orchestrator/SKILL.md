...
description: Groom Agentic OS self-improvement proposals into spec packets and Linear issues. Use when the user asks for Agentic OS `aos-product-orchestrator` work or when the routed Agentic OS skill registry selects `aos-product-orchestrator`.
---
...
Harness-visible adapter for the Agentic OS `aos-product-orchestrator` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/aos-product-orchestrator/SKILL.md` after routing.
