---
name: room-builder
description: Turn discovery answers into OS rooms, routers, references, and context contracts. Use when the user asks for Agentic OS `room-builder` work or when the routed Agentic OS skill registry selects `room-builder`.
---
...
Harness-visible adapter for the Agentic OS `room-builder` skill.
...
3. Read `harness/rules/os-authoring-rules.md` before editing Agentic OS
   ...
   templates.
4. Read `harness/skills/room-builder/SKILL.md` after routing.
