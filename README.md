...
| Compact context | Resolves inherited workflow/automation context with provenance, detects copied contracts, and emits reversible migration plans. | `agentic-os context explain ...` / `context check` / `context compact --dry-run` |
