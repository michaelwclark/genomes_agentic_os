...
- Root `AGENTS.md`, `CLAUDE.md`, `CONTEXT.md`, `RULES.md`, and `TOOLS.md` exist.
- `CLAUDE.md` contains the `@AGENTS.md` adapter.
- `AGENT.md` is not generated by default.
- `los/ROUTER.md`, `los/AGENTS.md`, `los/CLAUDE.md`, `los/CONTEXT.md`, `los/RULES.md`, and `los/TOOLS.md` exist.
...
- Root `.agentic_root`, `README.md`, `ROUTER.md`, `AGENTS.md`, `CLAUDE.md`, `CONTEXT.md`, `RULES.md`, and `TOOLS.md` exist.
- `CLAUDE.md` files are short `@AGENTS.md` adapters.
- Existing `AGENT.md` files are reported as legacy compatibility warnings.
- Default domain roots exist.
- Each default domain has its router, context, rules, tools, config, numbered operating lanes, standard lane folders, knowledge files, activity log, metrics files, and archive placeholder.
