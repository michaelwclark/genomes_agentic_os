...
| `project worktree cleanup-closed` | Move cached terminal-status or merged-PR worktree registrations to `worktrees/closed.yml` and optionally remove clean in-project worktree directories | [13 · Agent Surfaces](13-agent-surfaces.md) | [§3](../.agentic-atlas/architecture/command-reference.md) |
