...
> This is Gap H in the retired atlas gap register (git history) — documented as an avoidable
...
Real output (abbreviated; re-captured against this branch):

```text
created: .../agentic_os
created: .../agentic_os/.agentic_root
created: .../agentic_os/harness
created: .../agentic_os/harness/bin
created: .../agentic_os/harness/commands
created: .../agentic_os/harness/skills
created: .../agentic_os/harness/mcp
created: .../agentic_os/harness/plugins
created: .../agentic_os/harness/libraries
created: .../agentic_os/harness/hooks
created: .../agentic_os/harness/rules
created: .../agentic_os/harness/registries
created: .../agentic_os/harness/registries/capabilities.yml
...
created: .../agentic_os/harness/README.md
created: .../agentic_os/harness/ROUTER.md
created: .../agentic_os/harness/AGENTS.md
created: .../agentic_os/harness/CLAUDE.md
...
Clean root output (real, from a transcript regenerated by `docs/architecture/tools/validate-cli.sh`):
...
created: .../agentic_os/acme/config.toml
...
created: .../agentic_os/acme/02-projects/launch/config.toml
...
updated: .../agentic_os/acme/00-control-plane/state-index.md
```
...
Real output (abbreviated — the project layer now contributes several
`config/*.yml` entries beyond what is shown here):
...
- .../agentic_os/harness/shared_factory/05-knowledge/references/naming-conventions.md
- .../agentic_os/harness/shared_factory/05-knowledge/references/tool-index.md
- .../agentic_os/harness/shared_factory/05-knowledge/references/source-priority.md
- .../agentic_os/harness/shared_factory/05-knowledge/references/style-and-output-rules.md
...
- .../agentic_os/acme/02-projects/launch/AGENTS.md
- .../agentic_os/acme/02-projects/launch/ROUTER.md
- .../agentic_os/acme/02-projects/launch/CONTEXT.md
...
approval_risks: []
known_gaps: []
handoff_prompt: Load the listed sources, work in .../agentic_os/acme/02-projects/launch,
...
- Atlas: [`command-reference.md`](architecture/command-reference.md)
