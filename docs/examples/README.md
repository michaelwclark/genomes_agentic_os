...
These small, documentation-only examples show how different domains can name
and explain their operating rooms. They are not installed automatically and do
not carry live state.
