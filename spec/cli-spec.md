...
| --- | --- |
| `init` | Create the domain-first installed OS tree, root/domain context-file contract, `CLAUDE.md` adapters, domain context/reference files, numbered domain lanes, shared runtime templates, operating manual, commands, skills, and plan backlog. |
