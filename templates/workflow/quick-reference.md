...
1. Read `workflow.md`.
2. Confirm `outcome-brief.md`, `alignment-questions.md`, `prd.md`, `implementation-plan.md`, and `dispatch-handoff.md` are ready.
3. Load `context-pack.md`.
4. Check `approval-rules.md`.
5. Execute from `runbook.md`.
6. Write the run log and update `progress.md`.
