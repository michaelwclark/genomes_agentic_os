# Feature Intake Compatibility Alias

This workflow remains for legacy `/new-feature` and `/add-feature` references.
Use `spec-intake.md` as the primary workflow for new specs, future work,
proposed features, plans, and Notion spec pages.
...
- "add this to Notion as a feature"
